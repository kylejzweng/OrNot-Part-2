...
plt.subplot(1, 2, 1)
header_compound_count.plot(kind = 'bar', color = 'royalblue')
plt.title('Headers')
plt.xlabel('Sentiment Score')
plt.ylabel('Count')

plt.subplot(1, 2, 2)
review_compound_count.plot(kind = 'bar', color = 'seagreen')
plt.title('Reviews')
plt.xlabel('Sentiment Score')
plt.ylabel('Count')
plt.suptitle('Distrubtion of VADER Compound Scores', fontweight = 'bold')
plt.tight_layout()
# plt.show()
...
plt.suptitle('VADER Sentiment Scores by Star Rating for Headers', fontweight = 'bold')
plt.tight_layout()
# plt.show()
...
plt.xlabel('Star Rating')
plt.ylabel('Compound Score')
plt.suptitle('VADER Sentiment Scores by Star Rating for Reviews', fontweight = 'bold')
plt.tight_layout()
# plt.show()
...
sns.scatterplot(data = df,
                ...
                y = 'headers_VADER_compound',
                color = 'royalblue')
plt.title('Relationship between Header and Review VADER Compound Scores', fontweight = 'bold')
...
plt.xlabel('Length of Review')
plt.ylabel('Compound Score')
plt.suptitle('VADER Sentiment Scores by Length of Reviews', fontweight = 'bold')
plt.tight_layout()
# plt.show()
...
average_review_comp_score_by_year.plot(kind='bar', ax=ax, color='royalblue', label='Avg Review Compound Score')
...
ax.set_xlabel('Year')
ax.set_ylabel('Avg Review Compound Score', color='black')
ax2.set_ylabel('Review Count', color='black')
ax.set_title('Average Review Compound Score and Review Count by Year', fontweight = 'bold')
...
average_review_comp_score_by_product_category.plot(kind = 'bar', color = 'royalblue')
plt.title('Average VADER Compound Score by Product Category', fontweight = 'bold')
...
df.to_csv('full_ornot_dataset.csv', encoding = 'utf-8-sig')